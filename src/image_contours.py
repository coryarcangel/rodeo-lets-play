...
if __name__ == '__main__':
    sources = [
        # 'src/img/henry_screenshots/sc-1.png',
        # 'src/img/henry_screenshots/sc-5.png',
        # 'src/img/henry_screenshots/sc-7.png',
        'src/img/new-x.png', 
        # 'src/img/henry_screenshots/sc-10.png',
        # 'src/img/henry_screenshots/sc-2.png',
        # 'src/img/henry_screenshots/sc-3.png',
        # 'src/img/henry_screenshots/sc-4.png',
        # 'src/img/redtest.png',
