...
const labelColorsMap = JSON.parse(`{
  "person": "blueviolet",
  "clock": "springgreen",
  "tvmonitor": "black",
  "laptop": "black",
  "traffic light": "chartreuse",
  "chair": "saddlebrown",
  "cell phone": "darkgrey",
  "bicycle": "gold",
  "car": "royalblue",
  ...
  "stop sign": "red",
  "teddy bear": "brown",
  "motorbike": "paleturquoise",
  "aeroplane": "mediumpurple",
  "bus": "linen",
  "train": "seagreen",
  "truck": "mediumblue",
  "boat": "lightslategrey",
  "fire hydrant": "sandybrown",
  "parking meter": "saddlebrown",
  "bench": "deeppink",
  "bird": "mediumorchid",
  "cat": "slateblue",
  "dog": "orchid",
  ...
  "suitcase": "thistle",
  "skis": "limegreen",
  "snowboard": "navajowhite",
  "kite": "steelblue",
  "baseball bat": "whitesmoke",
  "baseball glove": "gray",
  "surfboard": "sandybrown",
  "tennis racket": "lavender",
  "wine glass": "aqua",
  "cup": "darkkhaki",
  "fork": "darkred",
  "knife": "peachpuff",
  ...
  "orange": "orange",
  "broccoli": "palegreen",
  "carrot": "darkslategray",
  "hot dog": "lightsalmon",
  "pizza": "salmon",
  "donut": "crimson",
  "cake": "cornsilk",
  "sofa": "peachpuff",
  "pottedplant": "forestgreen",
  "bed": "violet",
  "diningtable": "rosybrown",
  "toilet": "slategray",
  "mouse": "yellow",
  "remote": "olivedrab",
  "keyboard": "darksalmon",
  ...
  "toaster": "lawngreen",
  "sink": "cornflowerblue",
  "refrigerator": "burlywood",
  "book": "darkblue",
  "vase": "white",
  "scissors": "powderblue",
  "hair drier": "sandybrown",
  "toothbrush": "lightsteelblue"
}`)
...
function getImageObjectColor(label, confidence) {
  if (labelColorsMap[label])    return colors[labelColorsMap[label]]
